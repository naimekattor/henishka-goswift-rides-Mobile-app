...
export default function RetailerWallet() {
  ...
  // Mock Transactions list matching screenshots
  ...
  return (
    <SafeAreaView className="flex-1 bg-brand-bg">
        ...
        <View className="flex-1">
          ...
          <ScrollView showsVerticalScrollIndicator={false} className="flex-1 p-6">
            ...
            <View className="bg-white p-5 rounded-3xl border border-slate-100 shadow-sm mb-6">
              ...
              {/* High Fidelity Custom View Chart (No External Dependencies) */}
      ...
      {activeView === "success" && (
        <View className="flex-1 bg-white">
          <ScrollView showsVerticalScrollIndicator={false} className="flex-1 p-6">
            {/* Top Visual success graphic vector mockup */}
